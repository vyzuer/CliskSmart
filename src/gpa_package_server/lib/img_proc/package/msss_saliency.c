...
#endif
#include <math.h>
#define __PYX_HAVE__msss_saliency
#define __PYX_HAVE_API__msss_saliency
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
/* Module declarations from 'msss_saliency' */
...
static double __pyx_f_13msss_saliency_iisum(__Pyx_memviewslice, Py_ssize_t, Py_ssize_t, Py_ssize_t, Py_ssize_t); /*proto*/
...
#define __Pyx_MODULE_NAME "msss_saliency"
int __pyx_module_is_main_msss_saliency = 0;

/* Implementation of 'msss_saliency' */
...
static PyObject *__pyx_pf_13msss_saliency_msss_saliency(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_lab); /* proto */
...
static char __pyx_k_invarea[] = "invarea";
...
static char __pyx_k_msss_saliency[] = "msss_saliency";
...
static char __pyx_k_home_vyzuer_Copy_Research_Proje[] = "/home/vyzuer/Copy/Research/Project/code/group-photography/gpa_package/lib/segmentation/package/msss_saliency.pyx";
...
static PyObject *__pyx_n_s_invarea;
...
static PyObject *__pyx_n_s_msss_saliency;
...
static double __pyx_f_13msss_saliency_iisum(__Pyx_memviewslice __pyx_v_iimg, Py_ssize_t __pyx_v_x1, Py_ssize_t __pyx_v_y1, Py_ssize_t __pyx_v_x2, Py_ssize_t __pyx_v_y2) {
  double __pyx_v_sum;
  double __pyx_r;
  ...
  __Pyx_RefNannySetupContext("iisum", 0);

  /* "msss_saliency.pyx":12
 * cdef double iisum(double[:, :] iimg, Py_ssize_t x1, Py_ssize_t y1, Py_ssize_t x2, Py_ssize_t y2):
 *     cdef double sum
 *     sum = 0             # <<<<<<<<<<<<<<
 *     if(x1>1 and y1>1) :
 ...
 *     elif(x1<=1 and y1>1) :
 */
  __pyx_t_2 = ((__pyx_v_x1 > 1) != 0);
  if (__pyx_t_2) {
  } else {
    __pyx_t_1 = __pyx_t_2;
    goto __pyx_L4_bool_binop_done;
  }
  __pyx_t_2 = ((__pyx_v_y1 > 1) != 0);
  __pyx_t_1 = __pyx_t_2;
  __pyx_L4_bool_binop_done:;
  if (__pyx_t_1) {

    /* "msss_saliency.pyx":14
 *     sum = 0
 *     if(x1>1 and y1>1) :
 *         sum = iimg[y2-1,x2-1]+iimg[y1-2,x1-2]-iimg[y1-2,x2-1]-iimg[y2-1,x1-2]             # <<<<<<<<<<<<<<
 *     elif(x1<=1 and y1>1) :
 ...
 */
    __pyx_t_3 = (__pyx_v_y2 - 1);
    __pyx_t_4 = (__pyx_v_x2 - 1);
    __pyx_t_5 = (__pyx_v_y1 - 2);
    __pyx_t_6 = (__pyx_v_x1 - 2);
    __pyx_t_7 = (__pyx_v_y1 - 2);
    __pyx_t_8 = (__pyx_v_x2 - 1);
    __pyx_t_9 = (__pyx_v_y2 - 1);
    __pyx_t_10 = (__pyx_v_x1 - 2);
    __pyx_v_sum = ((((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_iimg.data + __pyx_t_3 * __pyx_v_iimg.strides[0]) ) + __pyx_t_4 * __pyx_v_iimg.strides[1]) ))) + (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_iimg.data + __pyx_t_5 * __pyx_v_iimg.strides[0]) ) + __pyx_t_6 * __pyx_v_iimg.strides[1]) )))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_iimg.data + __pyx_t_7 * __pyx_v_iimg.strides[0]) ) + __pyx_t_8 * __pyx_v_iimg.strides[1]) )))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_iimg.data + __pyx_t_9 * __pyx_v_iimg.strides[0]) ) + __pyx_t_10 * __pyx_v_iimg.strides[1]) ))));
    goto __pyx_L3;
  }

  /* "msss_saliency.pyx":15
 *     if(x1>1 and y1>1) :
 *         sum = iimg[y2-1,x2-1]+iimg[y1-2,x1-2]-iimg[y1-2,x2-1]-iimg[y2-1,x1-2]
 *     elif(x1<=1 and y1>1) :             # <<<<<<<<<<<<<<
 *         sum = iimg[y2-1,x2-1]-iimg[y1-2,x2-1]
 ...
 */
    __pyx_t_11 = (__pyx_v_y2 - 1);
    __pyx_t_12 = (__pyx_v_x2 - 1);
    __pyx_t_13 = (__pyx_v_y1 - 2);
    __pyx_t_14 = (__pyx_v_x2 - 1);
    __pyx_v_sum = ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_iimg.data + __pyx_t_11 * __pyx_v_iimg.strides[0]) ) + __pyx_t_12 * __pyx_v_iimg.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_iimg.data + __pyx_t_13 * __pyx_v_iimg.strides[0]) ) + __pyx_t_14 * __pyx_v_iimg.strides[1]) ))));
    goto __pyx_L3;
  }

  /* "msss_saliency.pyx":17
 *     elif(x1<=1 and y1>1) :
 *         sum = iimg[y2-1,x2-1]-iimg[y1-2,x2-1]
 *     elif(y1<=1 and x1>1) :             # <<<<<<<<<<<<<<
 *         sum = iimg[y2-1,x2-1]-iimg[y2-1,x1-2]
 ...
 *         sum = iimg[y2-1,x2-1]
 */
    __pyx_t_15 = (__pyx_v_y2 - 1);
    __pyx_t_16 = (__pyx_v_x2 - 1);
    __pyx_t_17 = (__pyx_v_y2 - 1);
    __pyx_t_18 = (__pyx_v_x1 - 2);
    __pyx_v_sum = ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_iimg.data + __pyx_t_15 * __pyx_v_iimg.strides[0]) ) + __pyx_t_16 * __pyx_v_iimg.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_iimg.data + __pyx_t_17 * __pyx_v_iimg.strides[0]) ) + __pyx_t_18 * __pyx_v_iimg.strides[1]) ))));
    goto __pyx_L3;
  }
  /*else*/ {

    /* "msss_saliency.pyx":20
 *         sum = iimg[y2-1,x2-1]-iimg[y2-1,x1-2]
 *     else :
 *         sum = iimg[y2-1,x2-1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_v_sum = (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_iimg.data + __pyx_t_19 * __pyx_v_iimg.strides[0]) ) + __pyx_t_20 * __pyx_v_iimg.strides[1]) )));
  }
  __pyx_L3:;

  /* "msss_saliency.pyx":22
 *         sum = iimg[y2-1,x2-1]
 * 
 *     return sum             # <<<<<<<<<<<<<<
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_13msss_saliency_1msss_saliency(PyObject *__pyx_self, PyObject *__pyx_arg_lab); /*proto*/
static PyMethodDef __pyx_mdef_13msss_saliency_1msss_saliency = {"msss_saliency", (PyCFunction)__pyx_pw_13msss_saliency_1msss_saliency, METH_O, 0};
static PyObject *__pyx_pw_13msss_saliency_1msss_saliency(PyObject *__pyx_self, PyObject *__pyx_arg_lab) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("msss_saliency (wrapper)", 0);
  assert(__pyx_arg_lab); {
    __pyx_v_lab = __Pyx_PyObject_to_MemoryviewSlice_d_d_dc_double(__pyx_arg_lab); if (unlikely(!__pyx_v_lab.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 25; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  __Pyx_AddTraceback("msss_saliency.msss_saliency", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_13msss_saliency_msss_saliency(__pyx_self, __pyx_v_lab);
...
static PyObject *__pyx_pf_13msss_saliency_msss_saliency(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_lab) {
  ...
  __Pyx_memviewslice __pyx_v_ai = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_bi = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_sm = { 0, 0, { 0 }, { 0 }, { 0 } };
  double __pyx_v_invarea;
  double __pyx_v_lm;
  double __pyx_v_am;
  double __pyx_v_bm;
  Py_ssize_t __pyx_v_j;
  Py_ssize_t __pyx_v_k;
  Py_ssize_t __pyx_v_yo;
  Py_ssize_t __pyx_v_y1;
  Py_ssize_t __pyx_v_y2;
  Py_ssize_t __pyx_v_xo;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("msss_saliency", 0);

  /* "msss_saliency.pyx":28
 * 
 *     cdef Py_ssize_t height, width, dim
 *     height = lab.shape[0]             # <<<<<<<<<<<<<<
 *     width = lab.shape[1]
 *     dim = lab.shape[2]
 */
  __pyx_v_height = (__pyx_v_lab.shape[0]);

  /* "msss_saliency.pyx":29
 *     cdef Py_ssize_t height, width, dim
 *     height = lab.shape[0]
 *     width = lab.shape[1]             # <<<<<<<<<<<<<<
 *     dim = lab.shape[2]
 * 
 */
  __pyx_v_width = (__pyx_v_lab.shape[1]);

  /* "msss_saliency.pyx":30
 *     height = lab.shape[0]
 *     width = lab.shape[1]
 *     dim = lab.shape[2]             # <<<<<<<<<<<<<<
 * 
 *     cdef double[:, :] l = lab[:,:,0]
 */
  __pyx_v_dim = (__pyx_v_lab.shape[2]);

  /* "msss_saliency.pyx":32
 *     dim = lab.shape[2]
 * 
 *     cdef double[:, :] l = lab[:,:,0]             # <<<<<<<<<<<<<<
 *     # lm = np.mean(l)
 * 
 */
  __pyx_t_1.data = __pyx_v_lab.data;
  __pyx_t_1.memview = __pyx_v_lab.memview;
  __PYX_INC_MEMVIEW(&__pyx_t_1, 0);
  __pyx_t_1.shape[0] = __pyx_v_lab.shape[0];
__pyx_t_1.strides[0] = __pyx_v_lab.strides[0];
    __pyx_t_1.suboffsets[0] = -1;

__pyx_t_1.shape[1] = __pyx_v_lab.shape[1];
__pyx_t_1.strides[1] = __pyx_v_lab.strides[1];
    __pyx_t_1.suboffsets[1] = -1;

{
    Py_ssize_t __pyx_tmp_idx = 0;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_lab.shape[2];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_lab.strides[2];
 ...
 */
  ...
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_cumsum); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_cumsum); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_v_l, 2, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_axis, __pyx_int_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_6 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_5, __pyx_t_2); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __Pyx_GOTREF(__pyx_t_6);
  if (PyDict_SetItem(__pyx_t_6, __pyx_n_s_axis, __pyx_int_0) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_2, __pyx_t_6); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(__pyx_t_5);
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_cumsum); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_cumsum); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __pyx_memoryview_fromslice(__pyx_v_a, 2, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __Pyx_GOTREF(__pyx_t_5);
  if (PyDict_SetItem(__pyx_t_5, __pyx_n_s_axis, __pyx_int_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_3, __pyx_t_5); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_4);
  if (PyDict_SetItem(__pyx_t_4, __pyx_n_s_axis, __pyx_int_0) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(__pyx_t_3);
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_cumsum); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_cumsum); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __pyx_memoryview_fromslice(__pyx_v_b, 2, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_axis, __pyx_int_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_5, __pyx_t_6, __pyx_t_3); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_axis, __pyx_int_0) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_6 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_3, __pyx_t_2); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(__pyx_t_6);
  if (unlikely(!__pyx_t_7.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_v_bi = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "msss_saliency.pyx":46
 *     cdef double[:, :] bi = np.cumsum(np.cumsum(b, axis=1), axis=0)
 * 
 *     cdef double[:, :] sm = np.empty(shape=(height, width), dtype=np.double)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_empty); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 46; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_3 = PyInt_FromSsize_t(__pyx_v_height); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 46; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = PyInt_FromSsize_t(__pyx_v_width); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 46; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  ...
  __pyx_t_3 = 0;
  __pyx_t_4 = 0;
  if (PyDict_SetItem(__pyx_t_6, __pyx_n_s_shape, __pyx_t_5) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 46; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_double); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 46; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  if (PyDict_SetItem(__pyx_t_6, __pyx_n_s_dtype, __pyx_t_4) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 46; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_empty_tuple, __pyx_t_6); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 46; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(__pyx_t_4);
  if (unlikely(!__pyx_t_7.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 46; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_v_sm = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "msss_saliency.pyx":51
 * 
 ...
 */
    __pyx_t_10 = (__pyx_v_height - __pyx_v_j);
    ...
    __pyx_v_yo = ((Py_ssize_t)__pyx_t_12);

    /* "msss_saliency.pyx":53
 *     for j in range(1, height+1):
 *         yo = <Py_ssize_t>min(j, height-j)
 *         y1 = <Py_ssize_t>max(1,j-yo)             # <<<<<<<<<<<<<<
 *         y2 = <Py_ssize_t>min(j+yo,height)
 ...
 */
    __pyx_t_12 = (__pyx_v_j - __pyx_v_yo);
    __pyx_t_13 = 1;
    ...
    __pyx_v_y1 = ((Py_ssize_t)__pyx_t_10);

    /* "msss_saliency.pyx":54
 *         yo = <Py_ssize_t>min(j, height-j)
 *         y1 = <Py_ssize_t>max(1,j-yo)
 *         y2 = <Py_ssize_t>min(j+yo,height)             # <<<<<<<<<<<<<<
 *         for k in range(1, width+1):
 ...
 */
    ...
    __pyx_v_y2 = ((Py_ssize_t)__pyx_t_11);

    /* "msss_saliency.pyx":55
 *         y1 = <Py_ssize_t>max(1,j-yo)
 *         y2 = <Py_ssize_t>min(j+yo,height)
 *         for k in range(1, width+1):             # <<<<<<<<<<<<<<
 *             xo = <Py_ssize_t>min(k,width-k)
 ...
 */
      __pyx_t_12 = (__pyx_v_width - __pyx_v_k);
      ...
      __pyx_v_xo = ((Py_ssize_t)__pyx_t_15);

      /* "msss_saliency.pyx":57
 *         for k in range(1, width+1):
 *             xo = <Py_ssize_t>min(k,width-k)
 *             x1 = <Py_ssize_t>max(1,k-xo)             # <<<<<<<<<<<<<<
 *             x2 = <Py_ssize_t>min(k+xo,width)
 ...
 */
      __pyx_t_15 = (__pyx_v_k - __pyx_v_xo);
      __pyx_t_13 = 1;
      ...
      __pyx_v_x1 = ((Py_ssize_t)__pyx_t_12);

      /* "msss_saliency.pyx":58
 *             xo = <Py_ssize_t>min(k,width-k)
 *             x1 = <Py_ssize_t>max(1,k-xo)
 *             x2 = <Py_ssize_t>min(k+xo,width)             # <<<<<<<<<<<<<<
 *             invarea = 1.0/((y2-y1+1)*(x2-x1+1))
 ...
 */
      ...
      __pyx_v_x2 = ((Py_ssize_t)__pyx_t_14);

      /* "msss_saliency.pyx":59
 *             x1 = <Py_ssize_t>max(1,k-xo)
 *             x2 = <Py_ssize_t>min(k+xo,width)
 *             invarea = 1.0/((y2-y1+1)*(x2-x1+1))             # <<<<<<<<<<<<<<
 *             lm = iisum(li,x1,y1,x2,y2)*invarea
 ...
 */
      __pyx_v_invarea = (1.0 / (((__pyx_v_y2 - __pyx_v_y1) + 1) * ((__pyx_v_x2 - __pyx_v_x1) + 1)));

      /* "msss_saliency.pyx":60
 *             x2 = <Py_ssize_t>min(k+xo,width)
 *             invarea = 1.0/((y2-y1+1)*(x2-x1+1))
 *             lm = iisum(li,x1,y1,x2,y2)*invarea             # <<<<<<<<<<<<<<
 *             am = iisum(ai,x1,y1,x2,y2)*invarea
 ...
 */
      __pyx_v_lm = (__pyx_f_13msss_saliency_iisum(__pyx_v_li, __pyx_v_x1, __pyx_v_y1, __pyx_v_x2, __pyx_v_y2) * __pyx_v_invarea);

      /* "msss_saliency.pyx":61
 *             invarea = 1.0/((y2-y1+1)*(x2-x1+1))
 *             lm = iisum(li,x1,y1,x2,y2)*invarea
 *             am = iisum(ai,x1,y1,x2,y2)*invarea             # <<<<<<<<<<<<<<
 *             bm = iisum(bi,x1,y1,x2,y2)*invarea
 *             #---------------------------------------------------------
 */
      __pyx_v_am = (__pyx_f_13msss_saliency_iisum(__pyx_v_ai, __pyx_v_x1, __pyx_v_y1, __pyx_v_x2, __pyx_v_y2) * __pyx_v_invarea);

      /* "msss_saliency.pyx":62
 *             lm = iisum(li,x1,y1,x2,y2)*invarea
 *             am = iisum(ai,x1,y1,x2,y2)*invarea
 *             bm = iisum(bi,x1,y1,x2,y2)*invarea             # <<<<<<<<<<<<<<
 *             #---------------------------------------------------------
 ...
 */
      __pyx_v_bm = (__pyx_f_13msss_saliency_iisum(__pyx_v_bi, __pyx_v_x1, __pyx_v_y1, __pyx_v_x2, __pyx_v_y2) * __pyx_v_invarea);

      /* "msss_saliency.pyx":66
 *             # Compute the saliency map
 *             #---------------------------------------------------------
 ...
 */
      ...
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_sm.data + __pyx_t_19 * __pyx_v_sm.strides[0]) ) + __pyx_t_20 * __pyx_v_sm.strides[1]) )) = ((pow(((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_l.data + __pyx_t_14 * __pyx_v_l.strides[0]) ) + __pyx_t_12 * __pyx_v_l.strides[1]) ))) - __pyx_v_lm), 2.0) + pow(((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_a.data + __pyx_t_15 * __pyx_v_a.strides[0]) ) + __pyx_t_16 * __pyx_v_a.strides[1]) ))) - __pyx_v_am), 2.0)) + pow(((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_b.data + __pyx_t_17 * __pyx_v_b.strides[0]) ) + __pyx_t_18 * __pyx_v_b.strides[1]) ))) - __pyx_v_bm), 2.0));
    }
  }

  /* "msss_saliency.pyx":68
 *             sm[j-1,k-1] = (l[j-1,k-1]-lm)**2 + (a[j-1,k-1]-am)**2 + (b[j-1,k-1]-bm)**2
 * 
 *     img = (sm-np.min(sm))/(np.max(sm)-np.min(sm))             # <<<<<<<<<<<<<<
 * 
 *     return img
 */
  __pyx_t_4 = __pyx_memoryview_fromslice(__pyx_v_sm, 2, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 68; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_min); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 68; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_v_sm, 2, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 68; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = NULL;
  ...
  if (!__pyx_t_3) {
    __pyx_t_6 = __Pyx_PyObject_CallOneArg(__pyx_t_5, __pyx_t_2); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 68; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_GOTREF(__pyx_t_6);
  } else {
    __pyx_t_21 = PyTuple_New(1+1); if (unlikely(!__pyx_t_21)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 68; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    ...
    __Pyx_GIVEREF(__pyx_t_2);
    __pyx_t_2 = 0;
    __pyx_t_6 = __Pyx_PyObject_Call(__pyx_t_5, __pyx_t_21, NULL); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 68; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_DECREF(__pyx_t_21); __pyx_t_21 = 0;
  }
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = PyNumber_Subtract(__pyx_t_4, __pyx_t_6); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 68; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_21 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_max); if (unlikely(!__pyx_t_21)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 68; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_21);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __pyx_memoryview_fromslice(__pyx_v_sm, 2, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 68; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  ...
  if (!__pyx_t_2) {
    __pyx_t_6 = __Pyx_PyObject_CallOneArg(__pyx_t_21, __pyx_t_4); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 68; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_GOTREF(__pyx_t_6);
  } else {
    ...
    __Pyx_GIVEREF(__pyx_t_4);
    __pyx_t_4 = 0;
    __pyx_t_6 = __Pyx_PyObject_Call(__pyx_t_21, __pyx_t_3, NULL); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 68; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  }
  __Pyx_DECREF(__pyx_t_21); __pyx_t_21 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_min); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 68; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __pyx_memoryview_fromslice(__pyx_v_sm, 2, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 68; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = NULL;
  ...
  if (!__pyx_t_2) {
    __pyx_t_21 = __Pyx_PyObject_CallOneArg(__pyx_t_4, __pyx_t_3); if (unlikely(!__pyx_t_21)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 68; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_GOTREF(__pyx_t_21);
  } else {
    __pyx_t_22 = PyTuple_New(1+1); if (unlikely(!__pyx_t_22)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 68; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_22);
    PyTuple_SET_ITEM(__pyx_t_22, 0, __pyx_t_2); __Pyx_GIVEREF(__pyx_t_2); __pyx_t_2 = NULL;
    PyTuple_SET_ITEM(__pyx_t_22, 0+1, __pyx_t_3);
    __Pyx_GIVEREF(__pyx_t_3);
    __pyx_t_3 = 0;
    __pyx_t_21 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_22, NULL); if (unlikely(!__pyx_t_21)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 68; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_21);
    __Pyx_DECREF(__pyx_t_22); __pyx_t_22 = 0;
  }
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = PyNumber_Subtract(__pyx_t_6, __pyx_t_21); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 68; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __Pyx_DECREF(__pyx_t_21); __pyx_t_21 = 0;
  __pyx_t_21 = __Pyx_PyNumber_Divide(__pyx_t_5, __pyx_t_4); if (unlikely(!__pyx_t_21)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 68; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_21);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_v_img = __pyx_t_21;
  __pyx_t_21 = 0;

  /* "msss_saliency.pyx":70
 *     img = (sm-np.min(sm))/(np.max(sm)-np.min(sm))
 * 
 *     return img             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_ai, 1);
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "msss_saliency.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "msss_saliency._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_invarea, __pyx_k_invarea, sizeof(__pyx_k_invarea), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_msss_saliency, __pyx_k_msss_saliency, sizeof(__pyx_k_msss_saliency), 0, 0, 1, 1},
 ...
 *     cdef Py_ssize_t height, width, dim
 */
  __pyx_tuple__19 = PyTuple_Pack(25, __pyx_n_s_lab, __pyx_n_s_lab, __pyx_n_s_height, __pyx_n_s_width, __pyx_n_s_dim, __pyx_n_s_l, __pyx_n_s_a, __pyx_n_s_b, __pyx_n_s_li, __pyx_n_s_ai, __pyx_n_s_bi, __pyx_n_s_sm, __pyx_n_s_invarea, __pyx_n_s_lm, __pyx_n_s_am, __pyx_n_s_bm, __pyx_n_s_j, __pyx_n_s_k, __pyx_n_s_yo, __pyx_n_s_y1, __pyx_n_s_y2, __pyx_n_s_xo, __pyx_n_s_x1, __pyx_n_s_x2, __pyx_n_s_img); if (unlikely(!__pyx_tuple__19)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 25; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_tuple__19);
  __Pyx_GIVEREF(__pyx_tuple__19);
  __pyx_codeobj__20 = (PyObject*)__Pyx_PyCode_New(1, 0, 25, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__19, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_vyzuer_Copy_Research_Proje, __pyx_n_s_msss_saliency, 25, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__20)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 25; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initmsss_saliency(void); /*proto*/
PyMODINIT_FUNC initmsss_saliency(void)
#else
PyMODINIT_FUNC PyInit_msss_saliency(void); /*proto*/
PyMODINIT_FUNC PyInit_msss_saliency(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_msss_saliency(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("msss_saliency", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_msss_saliency) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "msss_saliency")) {
      if (unlikely(PyDict_SetItemString(modules, "msss_saliency", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_ImportFrom(__pyx_t_2, __pyx_n_s_pow); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 5; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_pow, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 5; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 *     cdef Py_ssize_t height, width, dim
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_13msss_saliency_1msss_saliency, NULL, __pyx_n_s_msss_saliency); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 25; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_msss_saliency, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 25; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init msss_saliency", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init msss_saliency");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
